...
def _sorted_unique_records(records: tuple[object, ...], record_type: type, field: str) -> tuple:
...
class RuntimeManifest:
    ...
    def __post_init__(self) -> None:
        ...
        protocols = _sorted_unique_records(self.protocols, Protocol, "protocols")
        capabilities = _sorted_unique_records(self.capabilities, Capability, "capabilities")
        dependencies = _sorted_unique_records(self.dependencies, Component, "dependencies")
...
class UnavailableReason:
    ...
    def __post_init__(self) -> None:
        ...
        _require_text(self.subject, "unavailable subject")
